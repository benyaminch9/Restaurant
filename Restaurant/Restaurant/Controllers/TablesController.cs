...
namespace Restaurant.Controllers
{
    public class TablesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,TableNumber,Person,Date,Time")] Table table)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,TableNumber,Person,Date,Time")] Table table)
        {
            if (id != table.ID)
            {
                return NotFound();
